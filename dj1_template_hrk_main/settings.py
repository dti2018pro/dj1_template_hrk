"""
Django settings for dj1_template_hrk_main project.
...
SECRET_KEY = 'boas7xq@#a8$czl#l(jv)k2up+@d8c9sl-qtt=1b51ady!n8q%'
...
ROOT_URLCONF = 'dj1_template_hrk_main.urls'
...
WSGI_APPLICATION = 'dj1_template_hrk_main.wsgi.application'
